...
class Book3 {
	...
	public Book3(int id, String name, String author, String publisher,
			int quantity) {
		this.id = id;
		this.name = name;
		this.author = author;
...
public class HashSetExample {
	...
	public static void main(String[] args) {
		HashSet<Book3> set = new HashSet<Book3>();
		// Creating Books
		Book3 b1 = new Book3(101, "Let us C", "Yashwant Kanetkar", "BPB", 8);
		Book3 b2 = new Book3(102, "Data Communications & Networking",
